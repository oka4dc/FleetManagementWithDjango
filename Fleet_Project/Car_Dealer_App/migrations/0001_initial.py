    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='Car_Dealer_App.area')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Car_Dealer_App.area')),
                ('dealer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Car_Dealer_App.cardealer')),
            ],
        ),
    ]
